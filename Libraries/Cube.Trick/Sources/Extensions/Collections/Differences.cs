...
public static class DiffMethods
{
    ...
    public static IEnumerable<Result<T>> Diff<T>(
        ...
        IEnumerable<T> older) => newer.Diff(older, Condition.DiffOnly);
    ...
    public static IEnumerable<Result<T>> Diff<T>(
        this IEnumerable<T> newer,
        IEnumerable<T> older,
        IEqualityComparer<T> comparer) => newer.Diff(older, comparer, Condition.DiffOnly);
    ...
    public static IEnumerable<Result<T>> Diff<T>(
        this IEnumerable<T> newer,
        IEnumerable<T> older,
        Func<T, T, bool> compare) => newer.Diff(older, compare, Condition.DiffOnly);
    ...
    public static IEnumerable<Result<T>> Diff<T>(
        ...
        Condition mask) => older.Diff(newer, new LambdaEqualityComparer<T>(compare), mask);
}
